...
stock IsPlayerClassApproved( playerid ) {
	...
	// bought xp
	if ( IsPlayerFBI( playerid ) && total_experience < 0.0 )
		return SendClientMessage( playerid, -1, ""COL_RED"[ERROR]"COL_WHITE" You need 0 Total XP to use this class." ), 0;

	if ( IsPlayerArmy( playerid ) && total_experience < 0.0 )
		return SendClientMessage( playerid, -1, ""COL_RED"[ERROR]"COL_WHITE" You need 0 Total XP to use this class." ), 0;

	if ( IsPlayerCIA( playerid ) && total_experience < 0.0 )
		return SendClientMessage( playerid, -1, ""COL_RED"[ERROR]"COL_WHITE" You need 0 Total XP to use this class." ), 0;
