...
hook OnScriptInit( )
{
//	static const ROBBERY_BOT_PAY = 14000; // max pay from robbing bots
	static const ROBBERY_SAFE_PAY = 2000; // max pay from robbing safes
	...
	CreateMultipleRobberies( "VCNR Cafe", 		floatround( float( ROBBERY_SAFE_PAY ) * 0.5 ), 2113.085693, -1784.66638, 12.95044, 180.00000, -1 );
	CreateMultipleRobberies( "VCNR's Cafe", 		floatround( float( ROBBERY_SAFE_PAY ) * 0.5 ), 2540.658691, 2013.840209, 10.289649, 90.000000, -1 );
	CreateMultipleRobberies( "VCNR Cafe", 		floatround( float( ROBBERY_SAFE_PAY ) * 0.5 ), 1978.945312, 2066.297607, 10.285301, 90.000000, -1 );
	CreateMultipleRobberies( "VCNR Cafe", 	floatround( float( ROBBERY_SAFE_PAY ) * 0.5 ), -1968.052612, 107.914459, 27.092870, 0.0000000, -1 );
...
//	CreateRobberyNPC( "Priest",						ROBBERY_BOT_PAY, 2383.1968,3193.2842,1017.7320,1.0113, 68, 39, 40, 41, 62, 24 );
	...
	CreateMultipleRobberies( "Hotel de Monggo", 	ROBBERY_SAFE_PAY, -1967.766357, 1367.773925, 6.879500000, 86.700000, 0 );
//	CreateRobberyNPC( "Hotel Bartender",			ROBBERY_BOT_PAY, -1944.5562,1362.2947,7.3546,86.4801, 126, 0 );

    CreateMultipleRobberies( "Superman Mansion",     ROBBERY_SAFE_PAY, 292,1160.5072,-2019.8027,69.0347,274.3318, 0 );
//CreateRobberyNPC( "Superman mansion",           ROBBERY_BOT_PAY,  292,1160.5112,-2019.0547,69.0347,282.3344, 0 );
