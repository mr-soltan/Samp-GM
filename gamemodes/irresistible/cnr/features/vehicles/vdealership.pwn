...
new
	...
	g_BuyableVehicleData 			[ ] [ E_BV_DATA ] =
	{
		...
		// Helicopters
		{ BV_TYPE_HELICOPTERS, 		487, 0, 6000000, 	"Maverick" },
		{ BV_TYPE_HELICOPTERS, 		417, 0, 5000000, 	"Leviathan" },
		{ BV_TYPE_HELICOPTERS, 		497, 1, 4700000, 	"Police Maverick" },
		{ BV_TYPE_HELICOPTERS, 		488, 1, 3000000, 	"SAN News Maverick" },
		{ BV_TYPE_HELICOPTERS, 		563, 0, 2850000, 	"Raindance" },
		{ BV_TYPE_HELICOPTERS, 		469, 1, 2800000, 	"Sparrow" },
		{ BV_TYPE_HELICOPTERS, 		548, 1, 2700000, 	"Cargobob" },

		// Bikes
		{ BV_TYPE_BIKES, 			522, 0, 2500000, 	"NRG-500" },
		{ BV_TYPE_BIKES, 			510, 0, 1700000, 	"Mountain Bike" },
		...
		// Convertiblies
		{ BV_TYPE_CONVERTIBLES, 	480, 0, 1500000, 	"Comet" },
		...
		// Industrial
		{ BV_TYPE_INDUSTRIAL, 		498, 1, 1750000, 	"Boxville" },
		...
		// Lowriders
		{ BV_TYPE_LOWRIDERS, 		535, 0, 1000000, 	"Slamvan" },
		{ BV_TYPE_LOWRIDERS, 		567, 0, 1000000, 	"Savanna" },
		...
		// Off road
		{ BV_TYPE_OFF_ROAD, 		444, 1, 2750000, 	"Monster" },
		{ BV_TYPE_OFF_ROAD, 		556, 1, 2000000, 	"Monster A" },
		{ BV_TYPE_OFF_ROAD, 		557, 1, 2000000, 	"Monster B" },
		{ BV_TYPE_OFF_ROAD, 		573, 1, 1600000, 	"Dune" },
		{ BV_TYPE_OFF_ROAD, 		579, 0, 1500000, 	"Huntley" },
		{ BV_TYPE_OFF_ROAD, 		470, 1, 1400000, 	"Patriot" },
		{ BV_TYPE_OFF_ROAD, 		495, 0, 1400000, 	"Sandking" },
		...
		// Public Service
		{ BV_TYPE_PUBLIC_SERVICE,	601, 1, 2000000, 	"S.W.A.T." },
		{ BV_TYPE_PUBLIC_SERVICE, 	596, 1, 1500000, 	"Police Car (LSPD)" },
		{ BV_TYPE_PUBLIC_SERVICE, 	597, 1, 1500000, 	"Police Car (SFPD)" },
		{ BV_TYPE_PUBLIC_SERVICE, 	598, 1, 1500000, 	"Police Car (LVPD)" },
		{ BV_TYPE_PUBLIC_SERVICE, 	416, 1, 1500000, 	"Ambulance" },
		{ BV_TYPE_PUBLIC_SERVICE, 	407, 1, 1500000, 	"Firetruck"},
		{ BV_TYPE_PUBLIC_SERVICE, 	544, 1, 1500000, 	"Firetruck LA" },
		{ BV_TYPE_PUBLIC_SERVICE, 	437, 1, 1000000, 	"Coach" },
		{ BV_TYPE_PUBLIC_SERVICE, 	427, 1, 1000000, 	"Enforcer" },
		{ BV_TYPE_PUBLIC_SERVICE, 	599, 1, 900000, 	"Police Ranger" },
		{ BV_TYPE_PUBLIC_SERVICE, 	438, 1, 900000,	"Cabbie" },
		{ BV_TYPE_PUBLIC_SERVICE,	431, 1, 900000,	"Bus" },
		{ BV_TYPE_PUBLIC_SERVICE,	528, 1, 900000, 	"FBI Truck" },
		{ BV_TYPE_PUBLIC_SERVICE, 	523, 1, 900000, 	"HPV1000" },
		{ BV_TYPE_PUBLIC_SERVICE, 	420, 1, 900000, 	"Taxi" },
		{ BV_TYPE_PUBLIC_SERVICE, 	490, 1, 750000, 	"FBI Rancher" },

		// Saloons
		{ BV_TYPE_SALOONS, 			580, 0, 3500000, 	"Stafford" },
		{ BV_TYPE_SALOONS, 			560, 0, 2200000, 	"Sultan" },
		{ BV_TYPE_SALOONS, 			562, 0, 1700000, 	"Elegy" },
		{ BV_TYPE_SALOONS, 			421, 0, 1650000,	"Washington" },
		{ BV_TYPE_SALOONS, 			426, 0, 1400000, 	"Premier" },
		{ BV_TYPE_SALOONS, 			492, 0, 675000, 	"Greenwood" },
		...
		{ BV_TYPE_SPORTS, 			451, 0, 3100000, 	"Turismo" },
		{ BV_TYPE_SPORTS, 			541, 0, 3000000, 	"Bullet" },
		{ BV_TYPE_SPORTS, 			415, 0, 2800000, 	"Cheetah" },
		{ BV_TYPE_SPORTS, 			494, 1, 2700000, 	"Hotring Racer A" },
		{ BV_TYPE_SPORTS, 			502, 1, 2600000, 	"Hotring Racer B" },
		{ BV_TYPE_SPORTS, 			503, 1, 2500000, 	"Hotring Racer C" },
		{ BV_TYPE_SPORTS, 			402, 0, 2450000, 	"Buffalo" },
		{ BV_TYPE_SPORTS, 			429, 0, 1650000, 	"Banshee" },
		{ BV_TYPE_SPORTS, 			565, 0, 1050000, 	"Flash" },
		{ BV_TYPE_SPORTS, 			477, 0, 1000000, 	"ZR-350" },
		{ BV_TYPE_SPORTS, 			506, 0, 900000,	"Super GT" },
		{ BV_TYPE_SPORTS, 			559, 0, 900000, 	"Jester" },
		{ BV_TYPE_SPORTS, 			602, 0, 900000, 	"Alpha" },
		{ BV_TYPE_SPORTS, 			587, 0, 650000, 	"Euros" },
		{ BV_TYPE_SPORTS, 			475, 0, 655000, 	"Sabre" },
		{ BV_TYPE_SPORTS, 			603, 0, 500000, 	"Phoenix" },
		{ BV_TYPE_SPORTS, 			589, 0, 500000, 	"Club" },
		{ BV_TYPE_SPORTS, 			496, 0, 250000, 	"Blista Compact" },
	...
	else if ( dialogid == DIALOG_VEHDEALER_OPTIONS )
	{
		...
		switch( listitem )
		{
			case 0:
			{
				...
				if ( GetPlayerScore( playerid ) < 0 ) return SendError( playerid, "You need at least 0 score to buy a vehicle." );
