...
new
	...
	{
		// Spoilers
		{ CATEGORY_SPOILERS, 0, 1023, "Fury", 5000 },
		{ CATEGORY_SPOILERS, 0, 1001, "Win", 6000 },
		{ CATEGORY_SPOILERS, 0, 1000, "Pro", 8000 },
		{ CATEGORY_SPOILERS, 0, 1016, "Worx", 8000 },
		{ CATEGORY_SPOILERS, 0, 1058, "Alien - Stratum", 8000 },
		{ CATEGORY_SPOILERS, 0, 1014, "Champ", 8100 },
		{ CATEGORY_SPOILERS, 0, 1003, "Alpha", 9100 },
		{ CATEGORY_SPOILERS, 0, 1002, "Drag", 10000 },
		{ CATEGORY_SPOILERS, 0, 1015, "Race", 11000 },
		{ CATEGORY_SPOILERS, 0, 1060, "X-Flow - Stratum", 11000 },
		{ CATEGORY_SPOILERS, 0, 1049, "Alien - Flash", 11000 },
		{ CATEGORY_SPOILERS, 0, 1162, "Alien - Jester", 15000 },
		{ CATEGORY_SPOILERS, 0, 1164, "Alien - Uranus", 16000 },
		{ CATEGORY_SPOILERS, 0, 1147, "Alien - Elegy", 19000 },
		{ CATEGORY_SPOILERS, 0, 1050, "X-Flow - Flash", 20000 },
		{ CATEGORY_SPOILERS, 0, 1138, "Alien - Sultan", 22000 },
		{ CATEGORY_SPOILERS, 0, 1158, "X-Flow - Jester", 24000 },
		{ CATEGORY_SPOILERS, 0, 1163, "X-Flow - Uranus", 25000 },
		{ CATEGORY_SPOILERS, 0, 1146, "X-Flow - Elegy", 27000 },
		{ CATEGORY_SPOILERS, 0, 1139, "X-Flow - Sultan", 32000 },
		...
		// Vents
		{ CATEGORY_VENTS, 0, 1142, "Left Oval Vents", 2000 },
		{ CATEGORY_VENTS, 0, 1143, "Right Oval Vents", 2000 },
		{ CATEGORY_VENTS, 0, 1144, "Left Square Vents", 4000 },
		{ CATEGORY_VENTS, 0, 1145, "Right Square Vents", 4000 },
		{ CATEGORY_VENTS, 3, 914, "Large Air Vent", 150000 },

		// Neon
		{ CATEGORY_NEON, 0, 18647, "Red Neon", 120000 },
		{ CATEGORY_NEON, 0, 18648, "Blue Neon", 120000 },
		{ CATEGORY_NEON, 0, 18649, "Green Neon", 120000 },
		{ CATEGORY_NEON, 0, 18650, "Yellow Neon", 120000 },
		{ CATEGORY_NEON, 0, 18651, "Pink Neon", 120000 },
		{ CATEGORY_NEON, 0, 18652, "White Neon", 120000 },
