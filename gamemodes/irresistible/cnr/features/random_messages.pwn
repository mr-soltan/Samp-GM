...
static stock
	g_randomMessages 				[ ] [ 137 ] =
	{
		...
		{ "{8ADE47}Stephanie:"COL_WHITE" Follow us on twitter! "COL_GREY"@mrsoltan2021{FFFFFF}!" },
		...
		{ "{8ADE47}Stephanie:"COL_WHITE" You can access our Discord server at {7289da}sfcnr1v1.freeforums.net/discord" },
		...
		{ "{8ADE47}Stephanie:"COL_WHITE" Check your global SG-CNR rank with "COL_GREY"/rank"COL_WHITE"!" },
