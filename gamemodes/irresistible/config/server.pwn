...
/* ** Definitions ** */
#define SERVER_NAME					"[L|SF] Life in San Fierro [Cnr]"
#define SERVER_MODE_TEXT 			"Cops And Robbers / DM / Gangs"
#define SERVER_MAP 					"San Fierro"
#define SERVER_LANGUAGE				"English/All"
#define SERVER_WEBSITE				"Coming Soon"
#define SERVER_IP					"159.180.38.210:7777"
#define SERVER_TWITTER 				"mrsoltan2021"

/* ** Server Operator ** */
#define SERVER_OPERATOR 			"mr.soltan"
...
{
	return GetPlayerAccountID( playerid ) == SERVER_OPERATOR_ACC_ID|| GetPlayerAccountID( playerid ) == 2|| GetPlayerAccountID( playerid ) == 3|| GetPlayerAccountID( playerid ) == 4;
}
